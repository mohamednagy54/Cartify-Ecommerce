          ...
          <div className="absolute bottom-4 left-0 w-full flex flex-col justify-between p-6 text-white z-10">
            <div className="flex justify-between items-start">
              <div className="flex items-center gap-3">
                ...
                {alreadyInCart ? (
                <CounterProduct count={product.quantity} onIncrement={()=> handleCountOperations("i", product._id, alreadyInCart.count)} onDecrement={()=> handleCountOperations("d", product._id, count)} />
                ) : ()}
