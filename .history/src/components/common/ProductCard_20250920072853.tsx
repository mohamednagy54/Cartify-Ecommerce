...
export default function ProductCard({
  ...
  const cartItem = cart?.data.products.find((item) => item.product._id === product._id)
              ...
              <div className="flex items-center gap-3">
                ...
                {alreadyInCart ? (
                  <CounterProduct
                    ...
                    onIncrement={() =>
                      handleCountOperations("i", cartItem.product._id, product.quantity)
                    }
                    onDecrement={() =>
                      handleCountOperations("d", product._id, product.quantity)
                    }
                  />
                ) : (
                  <button
