...
export default function CheckoutPage() {
  ...
  const { cart, turncateText, formatPrice, handleLoggingOut } = useAppContext();
      ...
      <div className="w-full max-w-7xl  bg-white shadow-md rounded-lg p-8 grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="border rounded-lg p-6 bg-gray-100">
          ...
          <div className="flex gap-4 mt-6">
            <button
              className="flex-1 cursor-pointer bg-black text-white py-3 rounded-lg hover:bg-gray-800 transition-colors"
            ...
            <button
              ...
              className="flex-1 cursor-pointer bg-[#f14c6d] text-white py-3 rounded-lg transition-colors hover:bg-[#ef6c86]"
            >
              Secure Checkout
            </button>
          </div>
